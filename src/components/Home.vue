...
<div>
    <h1>Bowling Scores</h1>
        ...
        <div class="text-center" >
            ...
            <p v-if="showResponse.status == '200'" class="m-3" style="font-size: 2rem">Score posted with code: {{showResponse.status}} , and success: {{showResponse.success}} <b-icon icon="check-circle-fill" variant="success"></b-icon> </p>
